...
candyAnimationInst.prototype = {
	...
	init : function(){
		...
		var scrollPos = document.body.scrollTop || window.scrollY;
		
		if( scrollPos < this.top - window.innerHeight || scrollPos > ( this.top + rElePos.height ) + window.innerHeight ){
			
			var animationOffset = 200
			var dTranslate = "-" + animationOffset + "px, 0";
